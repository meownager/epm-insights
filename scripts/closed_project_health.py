#!/usr/bin/env python3
"""Closed Project Health Analysis Runner.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Closed project health deviation analysis")
...
def compute_metrics(
    ...
    merged = merged[status.isin(["closed", "completed"])].copy()
...
def main() -> None:
    ...
    detail_out = output_dir / "closed_project_health_detail.csv"
    ...
    summary_out = output_dir / "closed_project_health_summary.csv"
    summary.to_csv(summary_out, index=False)

    print("Closed Project Health Analysis complete.")
