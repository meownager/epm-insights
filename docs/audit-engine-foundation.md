...
The app should not begin with the interface. It should begin with the audit logic.
...
This phase should build strength in:

- Reading business data critically
- Defining project health metrics
- Writing SQL queries for audit analysis
- Translating project management judgment into repeatable rules
- Explaining findings clearly
- Preparing for later machine learning experiments
