# Closed Project Health MVP

## Purpose

This MVP audits closed engineering projects by comparing the proposed baseline against the actual outcome.
...
For each closed or completed project, calculate deviation for:
